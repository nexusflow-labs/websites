...
# description
Reusable Codex workflow for vue-api-integration tasks in this Vue + TypeScript + Pinia + Nx repo.

## Trigger cases
- Use when request clearly matches "vue-api-integration" outcomes.
