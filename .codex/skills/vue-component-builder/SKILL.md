...
# description
Reusable Codex workflow for vue-component-builder tasks in this Vue + TypeScript + Pinia + Nx repo.

## Trigger cases
- Use when request clearly matches "vue-component-builder" outcomes.
